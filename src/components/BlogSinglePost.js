        ...
        <div class="meta_blog_single">
           <div class="auto-container">
              <div class="row">
                 <div class="col-md-12">
                    <div class="left_side">
                       <div class="category"><a href="/" class="categors"><i class="icon-folder"></i>Coaching</a>
                       </div>
                       <div class="comments">
                          <i class="icon-text"></i>
                          <a href="#comment" class="Comments are Closed">Post Comment</a>
                       </div>
                    </div>
                    ...
                    <section class="blog_single_details_outer">
                       <div class="single_content_upper">
                          <div class="blog_feature_image">
                             <img src="assets/images/blog-image-9.jpg" class="wp-post-image" alt="img"/>
                          </div>
                          {/* <!--===============spacing==============--> */}
                             ...
                             <div class="row gutter_30px">
                                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0">
                                   <div class="simple_image_boxes">
                                      <img src="assets/images/single-post-gal-1.jpg" class="simp_img img-fluid height_540px" alt=""/>
                                   </div>
                                   {/* <!--===============spacing==============--> */}
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                   <div class="simple_image_boxes">
                                      <img src="assets/images/blog-image-9.jpg" class="simp_img img-fluid height_260" alt=""/>
                                   </div>
                                   {/* <!--===============spacing==============--> */}
                                   <div class="pd_bottom_30"></div>
                                   {/* <!--===============spacing==============--> */}
                                   <div class="simple_image_boxes ">
                                      <img src="assets/images/single-post-gal-2.jpg" class="simp_img img-fluid height_250px" alt=""/>
                                   </div>
                                </div>
                             </div>
                             ...
                             <div class="d-flex">
                                ...
                                <div class="share_content right_one">
                                   <div class="share_socail">
                                      ...
                                      <button class="m_icon" title="facebook" data-sharer="facebook" data-title="blog single" data-url="blog-single.html">
                                         <i class="fa fa-facebook"></i>
                                      </button>
                                      <button class="m_icon" title="twitter" data-sharer="twitter" data-title="blog single" data-url="blog-single.html">
                                         <i class="fa fa-twitter"></i>
                                      </button>
                                      <button class="m_icon" title="whatsapp" data-sharer="whatsapp" data-title="blog single" data-url="blog-single.html">
                                         <i class="fa fa-whatsapp"></i>
                                      </button>
                                      <button class="m_icon" title="telegram" data-sharer="telegram" data-title="blog single" data-url="blog-single.html" data-to="+44555-03564">
                                         <i class="fa fa-telegram"></i>
                                      </button>
                                      <button class="m_icon" title="skype" data-sharer="skype" data-url="blog-single.html" data-title="blog single">
                                      ...
                                      <div id="respond" class="comment-respond">
                                         ...
                                         <form action="#" method="post" id="commentform" class="comment-form">
                                            ...
                                            <p class="comment-form-url">
                                               ...
                                               <input id="url" name="url" placeholder="ex. www.example.com" type="text" value="" size="30"/>
                                            </p>
                                            <p class="custom-control custom-checkbox">
                                               ...
                                               <label class="custom-control-label pl-1 c-gray" for="wp-comment-cookies-consent">Save my name, and email in this
                          ...
                          <div class="swiper-container" data-swiper='{
                             ...
                             <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                   <div class="news_box default_style list_view normal_view clearfix has_images">
                                      <div class="image img_hover-1">
                                         <img src="assets/images/blog-image-7.jpg" class="img-fluid" alt="img"/>
                                ...
                                <div class="swiper-slide">
                                   <div class="news_box default_style list_view normal_view clearfix has_images">
                                      <div class="image img_hover-1">
                                         <img width="750" height="420" src="assets/images/blog-image-6.jpg" class="img-fluid" alt="img"/>
                                         <a href="/" class="categories">
                                ...
                                <div class="swiper-slide">
                                   <div class="news_box default_style list_view normal_view clearfix has_images">
                                      <div class="image img_hover-1">
                                         <img width="750" height="420" src="assets/images/blog-image-9.jpg" class="img-fluid" alt="img"/>
                                         <a href="/" class="categories">
                                            <i class="icon-folder"></i>Coaching
                                         </a>
                                      </div>
