            ...
            <div className="col-xl-6 col-lg-12">
              ...
              <div className="progress_bar style_two">
                <div className="progress_new">
                  <div className="ProgressBar ProgressBar--animateText" data-progress="84">
                    <svg className="ProgressBar-contentCircle" height="170" width="170">
                      ...
                      <circle transform="rotate(-90, 85, 85)" className="ProgressBar-circle" cx="85" cy="85" r="75" style={{strokeDasharray: "471px", strokeDashoffset: "75.36px"}}></circle>
                    </svg>
                  </div>
                ...
                <div className="content_box">
                  ...
                  <p>Certain circumstances seds owing to the claims duty righteous indignation and so beguiled.</p>
                </div>
              </div>
