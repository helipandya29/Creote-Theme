  ...
  return (
    <div id="page" className="page_wapper hfeed site">
      <div className="style-switcher">
        ...
        >
          <li>
            <Link to="#" style={{ backgroundColor: "#078586" }}>
              {" "}
            </Link>
          </li>
          <li>
            <Link to="#" style={{ backgroundColor: "#e5102a" }}>
              {" "}
            </Link>
          </li>
          <li>
            <Link to="#" style={{ backgroundColor: "#3ead3c" }}>
              {" "}
            </Link>
          </li>
          <li>
            <Link to="#" style={{ backgroundColor: "#fed000" }}>
              {" "}
            </Link>
          </li>
          <li>
            <Link to="#" style={{ backgroundColor: "#ff5538" }}>
              {" "}
            </Link>
          </li>
          <li>
            <Link to="#" style={{ backgroundColor: "#246af4" }}>
              {" "}
            </Link>
          </li>
        </ul>
