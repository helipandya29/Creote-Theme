...
import HumanResource from "./Home/HumanResource.js";
                                    ...
                                    <div className="tab_over_all_box">
                                        <div className="tabs_header clearfix">
                                            <ul className="showcase_tabs_btns nav-pills nav clearfix">
                                                <li className="nav-item">
                                                    <a
                                                        href="#"
                                                        className={`s_tab_btn nav-link ${activeTab === "tabtabone" ? "active" : ""}`}
                                                        onClick={(e) => handleTabClick(e, "tabtabone")}
                                                    >
                                                        01. Benefits
                                                    </a>
                                                </li>
                                                <li className="nav-item">
                                                    <a
                                                        href="#"
                                                        className={`s_tab_btn nav-link ${activeTab === "tabtabtwo" ? "active" : ""}`}
                                                        onClick={(e) => handleTabClick(e, "tabtabtwo")}
                                                    >
                                                        02. HR Advice
                                                    </a>
                                                </li>
                                                <li className="nav-item">
                                                    <a
                                                        href="#"
                                                        className={`s_tab_btn nav-link ${activeTab === "tabtabtwothree" ? "active" : ""}`}
                                                        onClick={(e) => handleTabClick(e, "tabtabtwothree")}
                                                    >
                                                        03. HR Audit
                                                    </a>
                                                </li>
                                        ...
                                        <div className="s_tab_wrapper">
                                            <div className="s_tabs_content">
                                                ...
                                                <div className={`s_tab fade ${activeTab === "tabtabtwothree" ? "active-tab show" : ""}`} id="tabtabtwothree">
                                                    <div className="tab_content one">
                                                        <div className="row">
                                                            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-0 mb-xl-0">
                                                                <div className="image">
