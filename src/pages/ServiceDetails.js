...
const ServiceDetails = () =>{
    return(
        <div id="page" className="page_wapper hfeed site" style={{marginTop : "100px"}}>
            <SecondHeader page="Service Details"/>
        {/* <!---============== wrapper_full =================--> */}
                                      ...
                                      <div className="icon_box_all style_one">
                                         <div className="icon_content ">
                                            ...
                                            <div className="txt_content">
                                               <h3>
                                                  <a href="/" target="_blank" rel="nofollow">Background Checks</a>
                                               </h3>
                                   ...
                                   <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 ps-0 ps-lg-0 pe-0 pe-lg-0 ps-xl-3">
                                      <div className="icon_box_all style_one">
                                         <div className="icon_content ">
                                            ...
                                            <div className="txt_content">
                                               <h3>
                                                  <a href="/" target="_blank" rel="nofollow">Profile Assessments</a>
                                               </h3>
                                      ...
                                      <div className="icon_box_all style_one">
                                         <div className="icon_content ">
                                            ...
                                            <div className="txt_content">
                                               <h3>
                                                  <a href="/" target="_blank" rel="nofollow">Position Description</a>
                                               </h3>
                                      ...
                                      <div className="accordion">
                                         <dl>
                                            <dt className="faq_header active">
                                               Who is Qetus?<span className="icon-play"></span>
                                            </dt>
                                            <dd className="accordion-content hide" style={{ display: 'block' }}>
                                               <p>
                                            ...
                                            <dt className="faq_header">
                                               What recruitment services do you offer?<span className="icon-play"></span>
                                            </dt>
                                            <dd className="accordion-content hide">
                                               <p>
                                            ...
                                            <dt className="faq_header">
                                               How can I register a job?<span className="icon-play"></span>
                                            </dt>
                                            <dd className="accordion-content hide">
                                               <p>
                                                  Serenity Is Multi-Faceted Blockchain Based Ecosystem, Energy Retailer For The People, Focusing On The Promotion Of Sustainable Living, Renewable Energy Production And Smart Energy Grid Utility Services.               
                                ...
                                <div className="widgets_grid_box">
                                   <div className="widget creote_widget_service_list">
                                      ...
                                      <ul className="service_list_box">
                                         ...
                                         <li><a href="/">Health Care Benefits</a> </li>
                                   ...
                                   <div className="contact_box_widget widget_box">
                                      <div className="widget_content">
                                         ...
                                         <div className="bottom_section">
                                            <a href="tel:http://+98%20060%20712%2034" className="phone_number">+98 060 712 34</a>
                                            <a href="mailto:http://sendmail@qetus.com" className="mailid">sendmail@qetus.com</a>
                                         </div>
                                      </div>
